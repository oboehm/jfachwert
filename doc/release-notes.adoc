...
* toleranterer Ortsvergleich: für den Vergleich wird jetzt die PLZ herangezogen.
  Fehlt diese, wird der Ortsnamen verglichen.
  (_Achtung_: bis 2.0 wurden Ort mit und ohne PLZ als unterschiedlich angesehen)
