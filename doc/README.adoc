...
.Builds
|===
|Branch |https://travis-ci.com/github/oboehm/jfachwert/branches[Travis-CI.com] |https://sonarcloud.io/projects[sonarcloud.io]|https://coveralls.io/github/oboehm/jfachwert[CoverAlls.io] |https://codecov.io/gh/oboehm/jfachwert[codecov.io]
