 ...
 * >how-to-validate-email-address-with-regular-expression</a> und aus <a href=
 * "https://de.wikipedia.org/wiki/E-Mail-Adresse">Wikipedia</a>.
 *
 * @author oboehm
 */
class EMailAdresseValidatorTest {
    ...
    void testValidEmailAdresse(String emailAdresse) {
    ...
    void testInvalidEmailAdresse(String emailAdresse) {
