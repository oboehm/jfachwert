...
Mit v4.4 wurde die Abhänigkeit zu commons-text wieder entfernt, da Kotlin hierfür genügend Unterstützung anbietet, um die fehlende Funktionalität selbst zu implementieren.
