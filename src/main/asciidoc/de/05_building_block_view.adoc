...
Ab 1.0 kam die Geldbetrag-Klasse hinzu, die das MonetaryAmount-Interface implementiert.
...
Wird eine höhere Genauikgeit gewünscht, kann dies über einen zusätzlichen MonetaryContext-Parameter beim Konstruktor der der valueOf-Methode eingestellt werden.
