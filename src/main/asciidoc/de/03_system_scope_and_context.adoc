...
jFachwert benötigt mindestens Java 11 oder Kotlin 2.0 und verwendet http://docs.oracle.com/javase/8/docs/api/java/util/Optional.html?is-external=true[Optional] für optionale Parameter und Rückgabewerte.
